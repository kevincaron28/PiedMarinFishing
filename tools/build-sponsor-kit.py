...
.section { margin-bottom: 0.07in; }
ul { list-style: none; }
li { position: relative; padding: 1.6pt 0 1.6pt 15pt; font-size: 8.8pt; line-height: 1.28; color: #2c4351; }
...
print("\nÉtape suivante :\n  node tools/render-sponsor-kit.js %s" % OUT)
